            ...
            >
              ...
              <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div className="max-w-lg">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-zinc-300">{signature.pitch}</p>
          ...
          {rest.map((module, index) => (
            <Reveal key={module.slug} delay={index * 60}>
              <Link href={module.href} className="card-lift surface flex h-full flex-col p-5">
                ...
                <div className="mt-4 flex flex-wrap gap-x-4 gap-y-1 border-t border-white/8 pt-3">
          ...
          <div className="mt-14">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {platformCapabilities.map((cap) => (
                <div key={cap.title} className="rounded-xl border border-white/8 bg-white/[0.02] p-4">
