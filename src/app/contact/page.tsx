      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[0.9fr_1.1fr]">
        <Reveal>
          <ul className="space-y-4 text-sm text-zinc-300">
            <li className="flex items-start gap-3 rounded-xl border border-white/10 bg-[#101119] p-4">
        ...
        <Reveal delay={80}>
          <div className="rounded-2xl border border-white/10 bg-[#101119] p-6 sm:p-8">
