    ...
    >
      ...
      >
        {modules.map((module, index) => (
          <Link
            ...
            data-card
            href={module.href}
            className="group relative h-64 w-64 shrink-0 snap-start overflow-hidden rounded-2xl border border-black/8 shadow-[0_1px_2px_rgb(16_17_20_/_4%)] sm:h-72 sm:w-72"
          >
            <div
      ...
      <div className="mt-4 flex justify-end gap-2">
        <button
          ...
          onClick={() => step(-1)}
          className="flex size-9 items-center justify-center rounded-full border border-black/10 bg-white text-zinc-600 shadow-sm transition-colors hover:border-primary/40 hover:text-primary"
        >
